...
var rollbar = new Rollbar({
  accessToken: "e8a43bbe74b34364920036fa457f8cbe",
...
app.get("/api/robots", (req, res) => {
  try {
    rollbar.info("Someone clicked 'get bots' button");
    res.status(200).send(botsArr);
  } catch (error) {
    rollbar.critical("Someone clicked 'get bots' button and was unsuccessful");
...
app.get("/api/player", (req, res) => {
  try {
    ...
    rollbar.critical("Someone tried to get player stats but was unsuccessful");
